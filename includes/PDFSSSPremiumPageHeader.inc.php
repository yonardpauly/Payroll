<?php
	...
	$FontSize =10;
	$pdf->selectFont('./fonts/Helvetica-Bold.afm');
	$Heading = _('SSS Monthly Remittance for All Employees');
	...
	$LeftOvers = $pdf->addTextWrap($Left_Margin+200,$YPos,50,$FontSize,'SSS Number','right');
	$LeftOvers = $pdf->addTextWrap($Left_Margin+290,$YPos,50,$FontSize,'SSS ER','right');
	$LeftOvers = $pdf->addTextWrap($Left_Margin+350,$YPos,50,$FontSize,'SSS EC','right');
	$LeftOvers = $pdf->addTextWrap($Left_Margin+410,$YPos,50,$FontSize,'SSS EE','right');			
